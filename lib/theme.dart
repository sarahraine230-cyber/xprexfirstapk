...
/// Vibrant, energetic color palette for XpreX video platform
class LightModeColors {
  // Primary: Bold purple-pink for creative energy
  ...
  // Tertiary: Vibrant pink for highlights
  ...
  // Surface and background: Clean white base
...
class DarkModeColors {
  ...
  // Surface and background: Deep dark mode
